...
def poscar_to_graph(name, poscar_dir, formula, parameters, cut_rds, nbr_type):
    ...
    _, inter_layer_index, crystal = countlayers(name, crystal_ori, layer_thresthold, num_surface_layer, num_inter_layer)
...
#     print(crystal.species[i])
    elements = [str(crystal.species[i]) for i in inter_layer_index2]
    ...
    atoms = crystal.frac_coords[inter_layer_index2]
